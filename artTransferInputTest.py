...
# https://images-na.ssl-images-amazon.com/images/I/61ySbUOxYRL._SX425_.jpg
...
content = load_img(content_filePath).astype('uint8') # change to desired content image
style = load_img(style_filePath).astype('uint8') # change to desired style image
...
best, best_loss = run_style_transfer(content_filePath,
                                     style_filePath, num_iterations=1000)
...
show_results(best, content_filePath, style_filePath)
